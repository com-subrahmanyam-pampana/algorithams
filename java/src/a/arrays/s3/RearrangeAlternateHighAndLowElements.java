...
/*
 Given an integer array, rearrange it 
 such that every second element becomes greater than its left and right elements. Assume no duplicate 
...
Output: {6, 9, 2, 5, 1, 4}
 * */
public class RearrangeAlternateHighAndLowElements {
