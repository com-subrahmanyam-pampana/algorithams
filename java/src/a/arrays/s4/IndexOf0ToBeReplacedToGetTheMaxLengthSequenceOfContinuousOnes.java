...
/*
 ...
 the array { 0, 0, 1, 0, 1, 1, 1, 0, 1, 1 }.
  We need to replace index 7 to get 
  the continuous sequence of length 6
   containing all 1’s.
 * */
public class IndexOf0ToBeReplacedToGetTheMaxLengthSequenceOfContinuousOnes {
